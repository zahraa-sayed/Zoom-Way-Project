...
class DriverChatScreen extends StatefulWidget {
  ...
  @override
  State<DriverChatScreen> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<DriverChatScreen> {
  ...
  Future<void> _fetchMessages() async {
    ...
    try {
      final result = await DriverApiService().getChatMessages(widget.rideId);
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      final result = await DriverApiService().sendMessage(
